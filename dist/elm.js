...
var _elm_lang$elm_architecture_tutorial$Types$UpdateTick = function (a) {
	return {ctor: 'UpdateTick', _0: a};
};
...
var _elm_lang$elm_architecture_tutorial$Types$UpdateKeyPress = function (a) {
	return {ctor: 'UpdateKeyPress', _0: a};
};
...
var _elm_lang$elm_architecture_tutorial$UpdateHelper$strToInt = function (str) {
	return A2(
		_elm_lang$core$Result$withDefault,
		0,
		_elm_lang$core$String$toInt(str));
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$createTempBoard = F2(
	function (model, pair) {
		var patternBoard = _elm_lang$core$Set$fromList(model.pattern);
		return A2(
			_elm_lang$core$Set$map,
			function (p) {
				var j = _elm_lang$core$Tuple$second(pair) + _elm_lang$core$Tuple$second(p);
				var i = _elm_lang$core$Tuple$first(pair) + _elm_lang$core$Tuple$first(p);
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Basics_ops['%'], i, _elm_lang$elm_architecture_tutorial$Constants$boardSize),
					_1: A2(_elm_lang$core$Basics_ops['%'], j, _elm_lang$elm_architecture_tutorial$Constants$boardSize)
				};
			},
			patternBoard);
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$shouldRedraw = F2(
...
var _elm_lang$elm_architecture_tutorial$UpdateHelper$updatedPos = F2(
	function (pair, board) {
...
var _elm_lang$elm_architecture_tutorial$UpdateHelper$newDict = function (model) {
	var board = model.board;
	var list = A2(
		_elm_lang$core$List$filter,
		function (p) {
			return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$updatedPos, p, board);
		},
		_elm_lang$elm_architecture_tutorial$Constants$fullBoard);
	return _elm_lang$core$Set$fromList(list);
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$decrementInterval = function (model) {
	var mayb = _elm_lang$core$List$maximum(
		{
			ctor: '::',
			_0: model.interval - _elm_lang$elm_architecture_tutorial$Constants$intervalStep,
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$Constants$intervalMin,
				_1: {ctor: '[]'}
			}
		});
	var val = A2(_elm_lang$core$Maybe$withDefault, _elm_lang$elm_architecture_tutorial$Constants$intervalMin, mayb);
	return _elm_lang$core$Native_Utils.update(
		model,
		{interval: val});
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$incrementInterval = function (model) {
	var mayb = _elm_lang$core$List$minimum(
		{
			ctor: '::',
			_0: model.interval + _elm_lang$elm_architecture_tutorial$Constants$intervalStep,
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$Constants$intervalMax,
				_1: {ctor: '[]'}
			}
		});
	var val = A2(_elm_lang$core$Maybe$withDefault, _elm_lang$elm_architecture_tutorial$Constants$intervalMax, mayb);
	return _elm_lang$core$Native_Utils.update(
		model,
		{interval: val});
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$updateTick = F2(
	function (model, newTime) {
		return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$shouldRedraw, newTime, model) ? _elm_lang$core$Native_Utils.update(
			model,
			{
				board: _elm_lang$elm_architecture_tutorial$UpdateHelper$newDict(model),
				lastUpdate: newTime
			}) : model;
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$updateOffsetJ = F2(
	function (model, str) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				jOffset: _elm_lang$elm_architecture_tutorial$UpdateHelper$strToInt(str)
			});
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$updateOffsetI = F2(
	function (model, str) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				iOffset: _elm_lang$elm_architecture_tutorial$UpdateHelper$strToInt(str)
			});
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$updateKeyPress = F2(
		...
		switch (_p0) {
			...
			case 32:
				return _elm_lang$core$Native_Utils.update(
					...
					{paused: !model.paused});
			case 187:
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$decrementInterval(model);
			case 189:
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$incrementInterval(model);
			default:
				return model;
		}
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$updateInterval = F2(
	function (model, str) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _elm_lang$elm_architecture_tutorial$UpdateHelper$togglePause = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{paused: !model.paused});
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$setTempToBoard = F2(
	function (model, pair) {
		return model.isEraser ? _elm_lang$core$Native_Utils.update(
			model,
			{
				board: A2(_elm_lang$core$Set$remove, pair, model.board)
...
var _elm_lang$elm_architecture_tutorial$UpdateHelper$setTempBoard = F2(
	function (model, pair) {
		return model.isEraser ? model : _elm_lang$core$Native_Utils.update(
			model,
			{
				tempBoard: A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$createTempBoard, model, pair)
			});
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$setPattern = F2(
	function (model, pattern) {
		return (_elm_lang$core$Native_Utils.eq(model.pattern, pattern) && (!model.isEraser)) ? _elm_lang$core$Native_Utils.update(
			model,
			{isEraser: true}) : _elm_lang$core$Native_Utils.update(
			model,
			{pattern: pattern, isEraser: false});
	});
var _elm_lang$elm_architecture_tutorial$UpdateHelper$setEraser = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{isEraser: !model.isEraser});
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$saveBoard = function (model) {
	return model;
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$clearTempBoard = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{tempBoard: _elm_lang$core$Set$empty});
};
var _elm_lang$elm_architecture_tutorial$UpdateHelper$clearBoard = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
...
var _elm_lang$elm_architecture_tutorial$Update$updatedModel = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'ClearBoard':
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$clearBoard(model);
			case 'ClearTempBoard':
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$clearTempBoard(model);
			case 'SaveBoard':
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$saveBoard(model);
			case 'SetEraser':
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$setEraser(model);
			case 'SetPattern':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$setPattern, model, _p1._0);
			case 'SetTempBoard':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$setTempBoard, model, _p1._0);
			case 'SetTempToBoard':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$setTempToBoard, model, _p1._0);
			case 'TogglePause':
				return _elm_lang$elm_architecture_tutorial$UpdateHelper$togglePause(model);
			case 'UpdateInterval':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$updateInterval, model, _p1._0);
			case 'UpdateKeyPress':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$updateKeyPress, _p1._0, model);
			case 'UpdateOffsetI':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$updateOffsetI, model, _p1._0);
			case 'UpdateOffsetJ':
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$updateOffsetJ, model, _p1._0);
			default:
				return A2(_elm_lang$elm_architecture_tutorial$UpdateHelper$updateTick, model, _p1._0);
		}
	});
...
var _elm_lang$elm_architecture_tutorial$View$gameRules = A2(
							...
							return A2(
								_elm_lang$html$Html$span,
								{
									...
									_0: _elm_lang$html$Html_Attributes$class(
										A2(_elm_lang$core$Basics_ops['++'], 'cell ', klass)),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'});
						},
...
var _elm_lang$elm_architecture_tutorial$View$offsetSlider = F3(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$max(
							_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Constants$boardSize - 1)),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Basics$toString(
										A2(_elm_lang$core$Basics_ops['%'], val, _elm_lang$elm_architecture_tutorial$Constants$boardSize))),
								_1: {
									ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$View$intervalSlider = function (interval) {
	return A2(
		_elm_lang$html$Html$input,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$min(
					_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Constants$intervalMin)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$max(
						_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Constants$intervalMax)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$step(
							_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Constants$intervalStep)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(
...
var _elm_lang$elm_architecture_tutorial$View$patternButton = F2(
	function (model, pattern) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$View$patternPreview(pattern),
				_1: {ctor: '[]'}
			});
	});
var _elm_lang$elm_architecture_tutorial$View$patternButtons = function (model) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			function (pattern) {
				return A2(_elm_lang$elm_architecture_tutorial$View$patternButton, model, pattern);
			},
			_elm_lang$elm_architecture_tutorial$Pattern$patterns));
};
var _elm_lang$elm_architecture_tutorial$View$clearButton = function (model) {
...
var _elm_lang$elm_architecture_tutorial$View$rgb = function (val) {
	var h = _elm_lang$core$Basics$toString(((360 * val) / ((_elm_lang$elm_architecture_tutorial$Constants$boardSize / 1) | 0)) | 0);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'hsl(',
		A2(_elm_lang$core$Basics_ops['++'], h, ',100%,80%)'));
};
var _elm_lang$elm_architecture_tutorial$View$drawCell = F3(
	function (model, i, j) {
		...
		var stylePairs = (hasTempLife || hasLife) ? {ctor: '[]'} : {
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'background-color',
				_1: _elm_lang$elm_architecture_tutorial$View$rgb(jVal - iVal)
			},
			_1: {ctor: '[]'}
		};
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('cell-container'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						...
						_0: _elm_lang$html$Html_Attributes$class(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									klass1,
									A2(_elm_lang$core$Basics_ops['++'], ' ', klass2)))),
						_1: {
							ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$View$drawRow = F2(
	function (model, i) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			A2(
				_elm_lang$core$List$map,
				A2(_elm_lang$elm_architecture_tutorial$View$drawCell, model, i),
				_elm_lang$elm_architecture_tutorial$Constants$boardIndexes));
	});
var _elm_lang$elm_architecture_tutorial$View$drawBoard = function (model) {
	var klass2 = model.isEraser ? 'eraser' : '';
	var klass1 = model.paused ? 'paused' : '';
	var board = model.board;
	return A2(
		_elm_lang$html$Html$div,
		{
		...
		A2(
			_elm_lang$core$List$map,
			_elm_lang$elm_architecture_tutorial$View$drawRow(model),
			_elm_lang$elm_architecture_tutorial$Constants$boardIndexes));
};
var _elm_lang$elm_architecture_tutorial$View$eraserButton = function (model) {
...
var _elm_lang$elm_architecture_tutorial$View$controls = function (model) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$elm_architecture_tutorial$View$pauseButton(model.paused),
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$View$clearButton(model),
				_1: {
					ctor: '::',
					_0: _elm_lang$elm_architecture_tutorial$View$intervalSlider(model.interval),
					_1: {
						ctor: '::',
						_0: _elm_lang$elm_architecture_tutorial$View$patternButtons(model),
						_1: {
							ctor: '::',
							_0: _elm_lang$elm_architecture_tutorial$View$eraserButton(model),
							_1: {
								ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$View$pageHeader = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$View$boardStuff = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('board-stuff'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A3(_elm_lang$elm_architecture_tutorial$View$offsetSlider, model.iOffset, _elm_lang$elm_architecture_tutorial$Types$UpdateOffsetI, 'vertical'),
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$View$drawBoard(model),
				_1: {
					ctor: '::',
					_0: A3(_elm_lang$elm_architecture_tutorial$View$offsetSlider, model.jOffset, _elm_lang$elm_architecture_tutorial$Types$UpdateOffsetJ, 'horizontal'),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _elm_lang$elm_architecture_tutorial$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container clearfix'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$elm_architecture_tutorial$View$pageHeader,
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$View$boardStuff(model),
				_1: {
					ctor: '::',
					_0: _elm_lang$elm_architecture_tutorial$View$controls(model),
					_1: {
						ctor: '::',
						_0: _elm_lang$elm_architecture_tutorial$View$gameRules,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _elm_lang$elm_architecture_tutorial$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _elm_lang$elm_architecture_tutorial$Constants$millisecondUpdate, _elm_lang$elm_architecture_tutorial$Types$UpdateTick),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_elm_lang$elm_architecture_tutorial$Types$UpdateKeyPress),
				_1: {ctor: '[]'}
			}
		});
};
